...
export const defaultChallenge: Challenge = {
  ...
  days: [
    ...
    { day: 1, ritual: "evening", title: "Sleep Stack 1 - Calm Down", microBite: "Action (1 min): Handy weglegen • Product (2 min): Sleep Stick trinken • Content (3 min): Box-Breathing Audio" },
