                  ...
                  {(dayNum === 1 || dayNum === 2) && activeTab === 'evening' && (
                      <div className="flex justify-center gap-2 mb-3">
                        <div className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full">
                          <span className="text-xs font-medium text-white">{dayNum === 1 ? '8–10 Min' : '1h 7 Min'}</span>
                        </div>
                ...
                <div>
                  ...
                  <div className="flex justify-center gap-3 mt-3">
                    <div className="bg-blue-100 dark:bg-blue-900/30 px-3 py-1 rounded-full flex items-center gap-1">
                      ...
                      <span className="text-xs font-medium text-blue-700 dark:text-blue-300">{dayNum === 1 ? '8–10 Min' : '1h 7 Min'}</span>
                    </div>
