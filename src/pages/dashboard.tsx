      ...
      <div className="min-h-screen flex flex-col bg-gray-50 relative" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
          ...
          <div className="fixed inset-0 z-50 flex">
            <div className="w-64 bg-white shadow-xl">
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
                <h2 className="text-xl font-bold text-green-600">rituals</h2>
                <button 
                  onClick={handleMenuToggle}
                  className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
                >
              ...
              <div className="p-4 space-y-2">
                <button className="w-full flex items-center gap-3 p-3 bg-green-50 text-green-600 rounded-lg">
        ...
        <div className="flex-1 px-4 py-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-4 overflow-x-auto pb-2">
              ...
              <div className="flex-shrink-0 w-80 bg-indigo-600 rounded-2xl p-4 text-white">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-sm text-indigo-200">7:22 pm</span>
                </div>
              ...
              {/* Welcome Pulse Card */}
              <div className="flex-shrink-0 w-64 bg-purple-600 rounded-2xl p-4 text-white">
                ...
                <button className="w-full bg-purple-700 text-white text-sm font-medium py-2 px-4 rounded-xl hover:bg-purple-800 transition-colors">
                  Get started
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-800">Steps</span>
                </div>
        ...
        <div className="px-4 pb-6">
          <button 
            ...
            className="w-full bg-green-600 text-white py-4 px-6 rounded-2xl font-medium hover:bg-green-700 transition-colors flex items-center justify-center gap-2 shadow-lg"
          >
